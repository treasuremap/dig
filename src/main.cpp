...
int64 nChainStartTime = 1401291140;
...
const string strMessageMagic = "Yamashitacoin Signed Message:\n";
...
static const int CUTOFF_HEIGHT = POW_CUTOFF_HEIGHT;	// Height at the end of 14 days
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in Yamashitacoin
    bool fStrictPayToScriptHash = true; // Always active in Yamashitacoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Yamashitacoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
      if (!fAllowNew)
        ...
        // Genesis block
        const char* pszTimestamp = "By Sabina Zawadzki and Gabriela Baczynska DONETSK, Ukraine, May 27 2014";
        CTransaction txNew;
        ...
        assert(block.hashMerkleRoot == uint256("a5aff1d1c4de9986ba7f45dd854d1082ce697386290718108d1723cf0400beae"));
...
unsigned char pchMessageStart[4] = { 0xac, 0xaa, 0xca, 0xbb };
